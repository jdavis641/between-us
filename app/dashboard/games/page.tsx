...
export default async function GamesHub() {  
  ...
  return ( <div className=min-h-screen" bg-zinc-950 text-zinc-100 p-6 md:p-12 pb-32 font-sans "selection:bg-rose-500/30> <div className=max-w-6xl" "mx-auto> <h1 className=text-4xl" md:text-5xl font-serif font-medium mb-4 "text-zinc-100>Intimacy Games</h1> <p className=text-zinc-400" mb-12 text-lg max-w-2xl font-light "leading-relaxed>Select a category to spark a new connection tonight. Hand-picked games designed specifically for your shared boundaries.</p> <GameList sections={sections} /> </div> </div> )  
} 
